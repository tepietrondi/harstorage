...
}), require.def("preview/menu", ["domplate/domplate", "core/lib", "domplate/toolbar", "core/trace"], function(Domplate, Lib, Toolbar, Trace) {
  with(Domplate) {
    function Menu() {}
    Menu.prototype = {
      render: function(a) {
        this.element = MenuPlate.render(a), this.toolbar = new Toolbar, this.toolbar.addButton({
          id: "credentials",
        ...
        var b = Lib.getElementByClass(this.element, "menuContent");
        this.toolbar.render(b), Lib.isWebkit && (b.style.paddingTop = "1px")
      },
    ...
    var MenuPlate = domplate({
      ...
      open: function(a) {
        var b = Lib.getAncestorByClass(a, "menu"),
          c = Lib.getElementByClass(b, "menuContent");
      ...
      toggle: function(a) {
        ...
        $(c).animate({
          ...
          var a = Lib.getElementByClass(b, "menuHandle");
          c.clientWidth > 0 ? Lib.setClass(a, "opened") : Lib.removeClass(a, "opened")
        })
      },
      render: function(a, b) {
...
}), require.def("harPreview", ["preview/requestList", "preview/pageList", "preview/harModel", "core/lib", "core/trace", "preview/menu", "preview/validationError"], function(a, b, c, d, e, f, g) {
  function h() {
    this.id = "harPreview", this.model = new c
  }
  h.prototype = {
    initialize: function(a) {
      this.topMenu = new f, this.topMenu.render(a);
      var b = d.bind(this.appendPreview, this),
        e = d.bind(this.onError, this);
      c.Loader.run(b, e)
    },
    appendPreview: function(a) {
      try {
        var f = !0,
          h = d.getURLParameter("validate");
        h == "false" && (f = !1);
        var j = c.parse(a, f);
        this.model.append(j);
        var k = new b(j);
        k.render(i), d.fireEvent(i, "onPreviewHARLoaded")
      } catch (l) {
        e.exception("HarPreview.appendPreview; EXCEPTION ", l), g.appendError(l, i)
      }
    },
    onError: function(a, b) {
      e.log("HarPreview; Load error ", a, b)
    },
    loadHar: function(a, b) {
      b = b || {};
      return c.Loader.load(this, a, b.jsonp, b.jsonpCallback, b.success, b.ajaxError)
    },
    setPreviewColumns: function(b, c) {
      a.setVisibleColumns(b, c)
    }
  };
  var i = document.getElementById("content"),
    j = i.repObject = new h;
  d.fireEvent(i, "onPreviewPreInit"), j.initialize(i), d.fireEvent(i, "onPreviewInit"), e.log("HarPreview; initialized OK")
})